...
@Database(entities = [Vehicle::class, Manufacturer::class, RawFueling::class], version = 16, exportSchema = true)
                ...
                synchronized(VehiclesDatabase::class.java) {
                    if (INSTANCE == null) {
                        INSTANCE = Room.databaseBuilder(
                            ...
                            .addCallback(object : Callback() { //reinstall app in case of empty entity in dev env
                                override fun onCreate(db: SupportSQLiteDatabase) {
                                    super.onCreate(db)
                                    /* TODO Get rid of addCallback, this should be in Splash Screen */
